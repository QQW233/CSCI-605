 ...
 * the output generated by the program is compared with the expected output given by the instructor
 * Need to uncomment line 41 in TollReport before use to include user input in comparison.
 *
